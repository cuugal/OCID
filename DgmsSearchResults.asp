...
dim b
dim z
'*************************writting the Sqls for the report***************
...
dcnDB.Open 
 ...
 '***********************************************************************
dim rsQueryOcc
set rsQueryOcc = Server.CreateObject("ADODB.Recordset")
	rsQueryOcc.Open "Select strOccupierName from tblOccupier",dcnDB
...
'******main loop query*************************************************** 
  dim strSQLEC
  strSQLEC = "Select * from tblEmergencyContact,tblOccupier,tblCampus where tblEmergencyContact.numCampusID = tblCampus.numCampusID "_
  &"And tblEmergencyContact.numOccupierID = tblOccupier.numOccupierId"
  
  Set rsQueryEC = Server.CreateObject("ADODB.Recordset")
  rsQueryEC.Open "Select distinct(tblOccupier.strOccupierName) AS strOccupierName,tblCampus.strAddress As strAddress,"_
  &"tblEmergencyContact.strEmergencyContactName1 AS strEmergencyContactName1,tblEmergencyContact.strEmergencyContactPosition1 AS strEmergencyContactPosition1,tblEmergencyContact.strEmergencyContactPhone1 AS strEmergencyContactPhone1,"_
  &"tblEmergencyContact.strEmergencyContactName2 AS strEmergencyContactName2,tblEmergencyContact.strEmergencyContactPosition2 AS strEmergencyContactPosition2,tblEmergencyContact.strEmergencyContactPhone2 AS strEmergencyContactPhone2,tblEmergencyContact.numCampusID AS numCampusID"_
  &" from tblEmergencyContact,tblOccupier,tblCampus where tblEmergencyContact.numCampusID = tblCampus.numCampusID "_
  &" order by tblEmergencyContact.numCampusID ",dcnDB
...
Dangerous Goods Manifest report</font><font face="Times New Roman"><br>Occupier&nbsp; : <%= rsQueryOcc("strOccupierName")%>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<BR>Date Prepared&nbsp; :&nbsp; <%= strDate %>
<br>
		  <table border="0" width="100%" id="table2">
	<tr>
		<td width="100" height="35">
		<table border="1" width="97" id="table3" cellspacing="0" cellpadding="0">
			<tr>
				<td bordercolor="#000000" width="93" height="35">&nbsp; HAZCHEM</td>
			</tr>
		</table>
		</td>
...
do while not rsQueryA.EOF %>
    ...
    <% do while not rsQueryB.EOF 
        ...
        if rsQueryA("numLocationId")= rsQueryB("numLocationId") then
...
'************************************ END OF CASE E******************************************************************                           
  ...
  <BR>
   <% strLocation = cstr(rsQueryA("strCampusName")) + ",&nbsp;&nbsp;"+ cstr(rsQueryA("strBuildingName"))+ ",&nbsp;&nbsp;"+ cstr(rsQueryA("strStoreLocation"))+ ",&nbsp;&nbsp;"+ cstr(rsQueryA("strStoreType"))+ ",&nbsp;&nbsp;"+ cstr(rsQueryA("strStoreNotes")) 
      strStoreManager = rsQueryA("strStoreManager") %>
       <b>Store Name :</b> <%=strLocation%>    <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Store Contact :</b> <%=strstoreManager%>
